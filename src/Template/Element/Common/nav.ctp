                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php if (!empty($authUser->profile_image)): ?>
                            <img src="<?= PROFILE_PATH . $authUser->profile_image ?>" class="img-circle" id="nav-user-profile-image" alt="Avatar">
                        <?php endif; ?>
                        <span id="nav-user-name"><?= $authUser->name ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
